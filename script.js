 const data = {
  ...
  contact: {
    phone: "099-999-99-99",
    email: "elibehramli2309@gmail.com",
    location: "Baku, Azerbaijan"
  },
  education: ["2024 - 2028, Azerbaijan Technical University, Information Security"],
  skills: ["Python (Basic)", "HTML", "C++", "Problem Solving"],
  languages: ["Azerbaijani (Native)", "English (B1-B2)", "Russian (Basic)"],
  experience: [
    "CyberSecure Tech (2023 - 2024), Intern – Security Analyst",
    "CodeLab Academy (2022), Student Project Contributor"
  ],
  references: ["Orxan Məmmədov – Senior Lecturer, AZTU – orxan.memmedov@aztu.edu.az"]
};
...
document.getElementById("cvForm").addEventListener("submit", function (e) {
  ...
  if (valid) {
    ...
    status.textContent = "Xahiş olunur, formu düzgün doldurun.";
